...
export default function Linimasa() {
    ...
    return (
        ...
        {/* <section className="lg:hidden">
            ...
            <img src={Line2} alt="" className="absolute left-[78px] pt-[58px]"/>
            <div className="flex flex-col text-cream max-w-[168px] ml-[110px] mt-[58px]">
                <div className="">
                    <h1 className="font-heading text-2xl">2020</h1>
                    <p className="font-body">Graduated from <b>SMA Negeri 2 Semarang</b>.</p>
                </div>
                <div className="">
                    <p className="">Entered college, majoring in <b>Information Engineering</b>.</p>
                </div>
                <div className="">
                    <h1 className="">2021</h1>
                    <p className="">Took part of <b>Find IT! 2021</b> as a Staff of Events Division.</p>
                </div>
                <div className="">
                    <p className="">Took part of Gelanggang Expo and Porsenigama 2021 as a Staff of IT Division. The team is responsible to create a static website for the events. Worked closely with other divisions as well.</p>
                </div>
                <div className="">
                    <p className="">Took part of NESCO 2022 as a Staff of Web Division. Mainly designing the website.</p>
